...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <a href="#rank" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true"
            aria-controls="collapseCardExample">
            <h6 class="m-0 font-weight-bold text-primary">Tahap Peringkingan</h6>
        </a>
        <!-- Card Content - Collapse -->
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <a href="{{ route('generate-spk-pdf') }}" class="btn btn-success mb-4">Export PDF</a>
